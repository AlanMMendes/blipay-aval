    ...
    <div className="flex h-auto justify-center items-center flex-col w-full max-w-[480px] rounded-lg ">
      ...
      >
        <div className="flex flex-col gap-4 h-auto rounded-lg p-4 justify-center items-center ">
          <h1 className="text-lg text-[#2F1A4B] text-center">
        ...
        <div className="absolute bottom-0 w-full h-auto flex justify-center items-center py-2 px-2">
          <button
            className="lg:border lg:border-opacity-50 lg:hover:border-[#2F1A4B] border-2 max-w-64 flex justify-center items-center max-h-12 border-[#2F1A4B] dark:text-black text-black rounded-full p-3 transition-all duration-200"
            type="submit"
          >
            <span className="text-[#2F1A4B]">Próximo</span>
          </button>
        </div>
      </form>
    </div>
